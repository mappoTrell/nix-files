  ...
  shared.base-system =
    { pkgs, lib, ... }:
    {
      ...
      services.udev.extraRules = ''
        ...
        SUBSYSTEMS=="usb", ATTRS{idVendor}=="16c0", ATTRS{idProduct}=="04[789ABCD]?", MODE:="0666", SYMLINK+="stm32_dfu"
        KERNEL=="ttyACM*", ATTRS{idVendor}=="16c0", ATTRS{idProduct}=="04[789B]?", MODE:="0666", SYMLINK+="stm32_dfu"
