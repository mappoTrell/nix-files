...
in {
  ...
  programs.niri.settings = {
    ...
    spawn-at-startup = [
      {argv = ["systemctl" "disable" "--now" "--user" "waybar.service"];}
    ];
    ...
    in
      pkgs.lib.attrsets.mergeAttrsList [
        {
          "Mod+T".action = uwsm "kitty";
          "Mod+Return".action = uwsm "ghostty";
          "Mod+O".action = show-hotkey-overlay;
          "Mod+Shift+Return".action = uwsm "walker";
          "Mod+W".action = sh (
